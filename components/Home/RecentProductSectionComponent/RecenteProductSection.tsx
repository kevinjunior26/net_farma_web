...
export function RecenteProductSection() {
    return (
        <section className="w-full flex flex-col justify-center py-16 gap-2">
            <h1 className="text-4xl font-bold text-black text-center">Produtos Mais Recentes</h1>
                ...
                <div className="grid grid-cols-1 gap-y-4">
                    <div className="bg-[#DCEDFD] w-[270px] h-[340px] flex-shrink-0 rounded p-8 overflow-hidden">
                        <div className="flex flex-col gap-y-3">
                            ...
                            <h1 className="text-2xl font-semiboldbold line-clamp-2">Grande Promoção</h1>
                        </div>
                    ...
                    <div className="bg-[#0A9A73] w-[270px] h-[440px] flex-shrink-0 rounded p-8 overflow-hidden">
                        <div className="flex flex-col gap-y-3">
                            <span className="text-xs text-white font-semiboldbold">HOT SALES</span>
                            <h1 className="text-2xl font-semiboldbold line-clamp-2">Covid-19 Mask Protection</h1>
                        </div>

                        <div className="h-[220px] relative flex flex-col justify-end">
                            <div
                                className="w-[160px] flex items-center justify-center py-2 absolute top-0 -left-7 gap-x-1 z-5">
                                <span className="text-xs font-light cursor-pointer">Comprar Agora</span>
                                <CircleChevronRight cursor={"pointer"} size={15}/>
                            </div>
                            <div
